...
FleetDefs<-read.csv(file=paste(getwd(),"/Data/FleetDefs.csv",sep=""),header=F,stringsAsFactors = F)            # Load the fleet definitions (unchanged from before reconditioning)
